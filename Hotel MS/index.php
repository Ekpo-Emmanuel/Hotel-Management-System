...
?>
    ...
    <section class="ftco-section ftco-services">
    	<div class="container">
    		<div class="row">
			<?php foreach($allHotels as $i) : ?> 
			<div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
				<div class="d-block services-wrap text-center">
					<div class="img" style="background-image: url('images/<?php echo $i->image?>')"></div>
					<div class="media-body py-4 px-3">
						<h3 class="heading"><?php echo $i->name ?></h3>
						<p><?php echo $i->description ?></p>
						<p>Location: <?php echo $i->location ?></p>
						<p><a href="rooms.php?id=<?php echo $i->id ?>" class="btn btn-primary">View rooms</a></p>
					</div>
				</div>      
			</div>
			<?php endforeach; ?>
    ...
    <section class="ftco-section bg-light">
			<div class="container-fluid px-md-0">
				...
				<div class="row no-gutters">
					<?php foreach($allRooms as $i) : ?>
					<div class="col-lg-6">
						<div class="room-wrap d-md-flex">
							<a href="<?php echo $appUrl ?>/rooms/room-single.php?id=<?php echo $i->id ?>" class="img" style="background-image: url(images/<?php echo $i->image ?>);"></a>
							<div class="half left-arrow d-flex align-items-center">
								<div class="text p-4 p-xl-5 text-center">
									<p class="star mb-0"><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span></p>
									<!-- <p class="mb-0"><span class="price mr-1">$120.00</span> <span class="per">per night</span></p> -->
									<h3 class="mb-3"><a href="rooms.html"><?php echo $i->name; ?></a></h3>
									<ul class="list-accomodation">
										<li><span>Max:</span> <?php echo $i->no_of_persons ?> Persons</li>
										<li><span>Size:</span> <?php echo $i->size ?> m2</li>
										<li><span>View:</span> <?php echo $i->view ?></li>
										<li><span>Bed:</span> <?php echo $i->no_of_beds ?></li>
									</ul>
									<p class="pt-1"><a href="<?php echo $appUrl ?>/rooms/room-single.php?id=<?php echo $i->id ?>" class="btn-custom px-3 py-2">View Room Details <span class="icon-long-arrow-right"></span></a></p>
								</div>
							</div>
						</div>
					</div>
